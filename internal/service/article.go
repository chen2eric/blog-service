...
import (
	"github.com/chen2eric/blog-service/internal/dao"
...
func (svc *Service) CreateArticle(param *CreateArticleRequest) error {
	...
	article, err := svc.dao.CreateArticle(&daoArticle)
	if err != nil {
		return err
	}
...
func (svc *Service) GetOneArticle(param *ArticleRequest) (*Article, error) {
	article, err := svc.dao.GetOneArticle(param.ID, param.State)
	if err != nil {
		return nil, err
	}
